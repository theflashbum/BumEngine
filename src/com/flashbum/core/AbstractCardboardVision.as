    ...
    public class AbstractCardboardVision extends Sprite implements ICardboardVision
    {
        ...
        protected function createContainer(data:XML):I3dContainer
        {
            ...
            if (className)
            {
                try
                {
                    tempContainer = instantiateContainer(className, data, tempContainer);
                }
        ...
        protected function instantiateContainer(className:String, data:XML, tempContainer:I3dContainer):I3dContainer {
