package com.flashbum.components.containers
{
    ...
    public class Abstract3dContainer extends EventDispatcher implements IComponent,I3dContainer
    {
        ...
        protected var _useMouseControls:Boolean = true;
        ...
        public function get useMouseControls():Boolean {
            return _useMouseControls;
        }

        public function set useMouseControls(value:Boolean):void {
            _useMouseControls = value;
        }
    }
}